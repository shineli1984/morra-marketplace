...
import { ItemPPicture, Settings, HeartIcon, Graph, MorraSign,ItemActivity, Close, 
    // CalendarIcon
...
function ItemPage() {
   ...
   const [selectedItems, setSelectedItems] = useState<{ name: string; id: number }[]>([]);
...
//    };
   ...
   const handleRowClick = (item: { column1: string }) => {
       ...
       if (!selectedItems.some((selectedItem) => selectedItem.name === firstWord)) {
           setSelectedItems([...selectedItems, { name: firstWord, id: Math.random() }]);
       }
   };

   const handleRowKeyDown = (event: React.KeyboardEvent<HTMLTableRowElement>, item: { column1: string }) => {
       if (event.key === 'Enter') {
           handleRowClick(item);
       }
   };
                        ...
                        <div className='item-info'>
                            ...
                            <div className='price'>
                                ...
                                <div className='actions'>
                                    <button className='custom-btn' onClick={handleModalShow} >BUY NOW</button>
            ...
            <div className='section-wrapper'>
              ...
              <Modal show={showModal} className='model-background' onHide={handleModalClose} centered>
                  <Modal.Body className='modelbody-background'>
                      ...
                      <p className='section-paragraph'>Various versions have evolved over the years.</p>
                      <div className='form-area'>
                          <div className='item-page-form-area-form-group'>
                              <label className='item-page-form-area-label'>DISCOUNT PRICE*</label>
                              <input type='text' placeholder='Enter discount' className='item-page-form-area-input' />
                          </div>
                          <div className='item-page-form-area-form-group'>
                              <label className='item-page-form-area-label'>SALES END AT</label>
                              <DatePicker
                                ...
                                />
                              <div className='item-page-form-area-manage-input'>
                              </div>
                          </div>
                      </div>
